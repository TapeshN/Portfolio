...
''' Tapesh Nagarwal October 13, 2015 '''
...
def litCricFriend(wordList, text):
    ...
    newList = text.lower().replace('-',' ').split(' ')
    ...
    returnList = []
    for word in newList:
        returnList.append(word.strip(string.punctuation))
    ...
    for words in wordList:
        counter = counter + returnList.count(words.lower())
    ...
    ratio = counter/ len(text.split(' '))
    return " Frequency " + str(ratio)
...
indefArtList = ['a','an']
defArtList = ['the']
print("theBells 'a' and 'an'" + litCricFriend(indefArtList,theBells))
print("theBells 'the'"+ litCricFriend(defArtList, theBells))
print("cantoXII 'a' and 'an'" + litCricFriend(indefArtList,cantoXII))
print("cantoXII 'the'" + litCricFriend(defArtList, cantoXII))
...
'''
Yes, Poe uses both 'a' and 'an' and 'the' a lot more than Neruda does.
This is evident in the output of the function call 
'''
